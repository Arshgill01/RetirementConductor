...
| RC-013 | Render CLI, report, DataHub summary, and gate from one canonical manifest | `docs/DECISIONS.md` | 04, 05 | [EP-004](EVIDENCE_LEDGER.md#ep-004--phase-04-reconciliation-and-producer-gate) binds CLI reconciliation, verified publication, producer plan, and gate to canonical manifest digests; phase 05 supplies operator rendering evidence |
