...
| R-09 | The product becomes a report or approval tracker rather than an executor | critical | contained for first vertical | One live campaign completed discovery, authorized Git mutation, native validation, reconciliation, verified publication, issued-plan gate, and producer sentinel; the rich campaign refused action | Looker must demonstrate that the same loop survives a heterogeneous second executor |
