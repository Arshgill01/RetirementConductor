...
| R-23 | The system cannot resume deterministically after interruption | high | testing | Phase 00 event and manifest digests are deterministic; durable replay is phase 01 work | Interrupt at every stage and reproduce the same safe state after restart |
