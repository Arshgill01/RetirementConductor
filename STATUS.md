...
- Current benchmark foundation commit: `ef02788`
...
- Last repository validation: generator commit `ef02788` passed 241 tests,
  Ruff, formatting, strict mypy, 174-file repository validation, a 307-file
...
| 06 | active | checkpoint B at `4148020` pins and verifies four official assets; checkpoint C at `ef02788` generated byte-identical medium twins, zero clean quality violations, three exact fault variants, 14 independent oracle scenarios, and executable official freshness/branch probes | ingest and directly reread the controlled DataHub graph, compare the policy with the oracle, run the exact Git/dbt campaign and refusal matrix, then promote public-safe evidence |
