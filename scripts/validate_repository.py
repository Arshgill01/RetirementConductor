...
REQUIRED_FILES = {
    ...
    "artifacts/public/phase06/reconciliation-evidence.json",
    ...
    "deploy/datahub/recipes/looker-lookml.yml",
    "deploy/datahub/recipes/looker-saved-look.yml",
    ...
    "fixtures/looker-lookml-project/README.md",
    "fixtures/looker-lookml-project/manifest.lkml",
    "fixtures/looker-lookml-project/retirement.model.lkml",
    "fixtures/looker-lookml-project/views/orders.view.lkml",
    ...
    "src/retirement_conductor/looker_access.py",
