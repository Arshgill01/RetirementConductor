...
REQUIRED_FILES = {
    ...
    "artifacts/public/definitive-unified-run/README.md",
    "artifacts/public/definitive-unified-run/index.json",
    ...
    "scripts/generate_definitive_unified_evidence.py",
    ...
    "tests/unit/test_definitive_unified_evidence.py",
