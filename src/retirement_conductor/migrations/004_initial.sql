DROP INDEX gate_attempts_consumed_manifest;
DROP INDEX gate_attempts_consumed_plan;
DROP INDEX gate_attempts_campaign;

ALTER TABLE gate_attempts RENAME TO gate_attempts_v3;
...
SELECT * FROM gate_attempts_v3;

DROP TABLE gate_attempts_v3;
