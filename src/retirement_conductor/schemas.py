...
SCHEMA_FILENAMES = {
    ...
    "benchmark-oracle": "benchmark-oracle-v1.schema.json",
    "benchmark-fault-manifest": "benchmark-fault-manifest-v1.schema.json",
    ...
    "semantic-validation-plan": "semantic-validation-plan-v1.schema.json",
    "semantic-model-acceptance": "semantic-model-acceptance-v1.schema.json",
    "github-pr-receipt": "github-pr-receipt-v1.schema.json",
    "producer-plan": "producer-plan-v1.schema.json",
    "producer-plan-v2": "producer-plan-v2.schema.json",
    "gate-receipt": "gate-receipt-v1.schema.json",
    "gate-receipt-v2": "gate-receipt-v2.schema.json",
